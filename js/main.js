...
const productSingleTabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_1__["default"]('productsingletabs');
const catalogTabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_1__["default"]('catalogtabs');
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.FreeMode, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs]);
document.addEventListener("DOMContentLoaded", function () {
  ...
  const swiperProductList = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".product-list__swiper", {
    slidesPerView: 4.3,
  ...
  const swiperProductListPopular = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".popular-product-swiper", {
    spaceBetween: 20,
    slidesPerView: 3,
    loop: true,
    breakpoints: {
  ...
  const swiperReviewsText = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".review-text-swiper", {
    spaceBetween: 20,
    slidesPerView: 1,
    loop: true,
    navigation: {
      nextEl: '.review-text-swiper-button-next',
      prevEl: '.review-text-swiper-button-prev'
    }
  });
  const swiperStudies = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".studies-swiper", {
    spaceBetween: 16,
    slidesPerView: 1.3,
    navigation: {
  ...
  function updateSlideCounter(swiper) {
    ...
    currentSlide.textContent = swiper.realIndex + 1; // текущий слайд
    totalSlides.textContent = swiper.slides.length; // общее количество слайдов
  }
  ...
  if (document.querySelector(".footer__nav-drop-button")) {
    ...
    showMoreButtons.forEach(function (button) {
      button.addEventListener("click", function () {
        ...
        if (footerList.classList.contains('footer__nav-column--expanded')) {
          footerList.classList.remove("footer__nav-column--expanded");
          button.innerHTML = "+";
        } else {
          footerList.classList.add("footer__nav-column--expanded");
          button.innerHTML = "-";
        }
      });
    });
  }
  if (document.querySelector(".sub-menu-item-drop-btn")) {
    const showMoreButtons = document.querySelectorAll(".sub-menu-item-drop-btn");
    showMoreButtons.forEach(function (button) {
      button.addEventListener("click", function () {
        const subMenuItem = button.closest(".sub-menu-item-products");
        if (subMenuItem.querySelector('.sub-menu-list-products').classList.contains('sub-menu-list-products--expanded')) {
          subMenuItem.querySelector('.sub-menu-list-products').classList.remove("sub-menu-list-products--expanded");
          button.classList.add("sub-menu-item-drop-btn--expanded");
        } else {
          subMenuItem.querySelector('.sub-menu-list-products').classList.add("sub-menu-list-products--expanded");
          button.classList.remove("sub-menu-item-drop-btn--expanded");
        }
      });
    });
  }
  if (document.querySelector(".btn-sub-menu")) {
    const showMoreButtons = document.querySelectorAll(".btn-sub-menu");
    const backButtons = document.querySelectorAll(".sub-menu-back");
    showMoreButtons.forEach(function (button) {
      button.addEventListener("click", function () {
        const subMenuContent = button.closest(".menu-mobile-item");
        subMenuContent.querySelector('.sub-menu-wrapper').classList.add("sub-menu-wrapper--open");
        toggleMenu();
      });
    });
    backButtons.forEach(function (button) {
      button.addEventListener("click", function () {
        const subMenuWrapper = button.closest('.sub-menu-wrapper');
        subMenuWrapper.classList.remove("sub-menu-wrapper--open");
        toggleMenu();
      });
    });
  }
  if (document.querySelector(".accordion__button")) {
    ...
    accordionButton.forEach(item => item.addEventListener("click", toggleAccordion));
  }
  if (document.querySelectorAll('[data-toggletablet="toggle"]')) {
    const toggleElements = document.querySelectorAll('[data-toggletablet="toggle"]');

    // Добавляем обработчик события change для каждого найденного элемента
    toggleElements.forEach(toggleElement => {
      toggleElement.addEventListener('change', () => {
        const parent = toggleElement.closest('.labels');
        if (parent) {
          const nextElement = parent.nextElementSibling;
          if (nextElement && nextElement.classList.contains('hide')) {
            nextElement.style.display = nextElement.style.display === 'none' ? '' : 'none';
            parent.classList.toggle('labels--close');
          }
        }
      });
    });
  ...
  var galleryMain = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".gallery-main", {
    watchOverflow: true,
    watchSlidesVisibility: true,
    watchSlidesProgress: true,
    effect: 'fade',
...
(function () {
  ...
  burger === null || burger === void 0 ? void 0 : burger.addEventListener('click', e => {
    ...
    if (menu !== null && menu !== void 0 && menu.classList.contains('menu--active')) {
      ...
      burger === null || burger === void 0 ? void 0 : burger.setAttribute('arifa-label', 'Закрыть меню');
